...
curl -X POST http://localhost:3409/api/account/create \
  ...
  -d '{
    "accountName": "微信测试账号",
    "platform": "wechat",
    "cookieFile": "/Users/endian/Library/Application Support/multi-account-browser/cookiesFile/wechat_用户_1753501967974_1753501987629.json",
